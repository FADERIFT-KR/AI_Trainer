...
from ai_trainer.squat.camera_views import VIEW_FRONT, VIEW_LABEL_KO, VIEW_LEFT, VIEW_RIGHT, VIEWS
from ai_trainer.squat.view_conditions import load_view_condition_config
